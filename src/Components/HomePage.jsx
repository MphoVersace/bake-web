    ...
    <div className="home-page">
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p><strong>THE HOME OF CUPCAKES <br />Polofields</strong><br />
          ...
          <p><strong>THE HOME OF CUPCAKES <br /> Neighbourhood</strong><br />
          ...
          <p><strong>THE HOME OF CUPCAKES <br /> V&A Waterfront</strong><br />
