...
const MenuPage = () => {
  const cake = [
    ...
    { name: 'Matcha Green Tea Cupcake', img: cake9, description: 'A unique cupcake made with earthy matcha green tea powder, topped with a light and sweet matcha buttercream frosting. Perfect for those who enjoy a sophisticated, slightly bitter flavor.' }, 
    { name: ' Pumpkin Spice Cupcakes', img: cake10, description:'A warmly spiced cupcake made with real pumpkin puree and a blend of autumn spices, topped with a cinnamon cream cheese frosting. Ideal for cozying up in the fall.' } ,
  ];
